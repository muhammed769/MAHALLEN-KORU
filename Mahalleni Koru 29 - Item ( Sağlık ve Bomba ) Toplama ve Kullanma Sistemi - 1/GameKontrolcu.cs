   ...
   #region Değişkenler
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.G))
        {
            ...
            Vector3 acimiz = Quaternion.AngleAxis(90, benimCam.transform.forward) * benimCam.transform.forward;  // 1 ) Açı derecesini belirttik  2 ) Bu açıyı BenimCameramdan İLERİYE göre hesaplayacağını söyledik ,
                                                                                                                 // 3 ) BenimCameramdan İLERİYE  doğru bir REFERANS ALMASINI SÖYLEDİK !!!!!!!!!!!!!
    ...
    public void Saglik_doldur()
    {
        ...
        {
            // Ses çalınabilir veya bildirim sesi olabilir.
        }
    }
